...
parser.add_argument("--data_dir", type=str, default="E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\BGFG\\Test\\LRD\\")
parser.add_argument("--sample_dir", type=str, default="E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\data\\output_u\\")
parser.add_argument("--model_name", type=str, default="funiegan") # or "ugan"
parser.add_argument("--model_path", type=str, default="E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\PyTorch\\b_models\\FunieGAN\\B_generator.pth")
