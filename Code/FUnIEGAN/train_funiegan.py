...
#train
#parser.add_argument("--cfg_file", type=str, default="E:/Project_MLDL_IPCV/UW IE and Super Resolution/Implementation/FUnIEGAN/FUnIE-GAN-master/FUnIE-GAN-master/PyTorch/configs/train_euvp.yaml")
parser.add_argument("--cfg_file", type=str, default="E:/Project_MLDL_IPCV/UW IE and Super Resolution/Implementation/FUnIEGAN/FUnIE-GAN-master/FUnIE-GAN-master/PyTorch/configs/train_ufo.yaml")
...
samples_dir = os.path.join("E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\PyTorch\\samples\\FunieGAN\\", dataset_name)
checkpoint_dir = os.path.join("E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\PyTorch\\checkpoints\\FunieGAN\\", dataset_name)
...
if args.epoch == 0:
    ...
    generator.load_state_dict(torch.load("E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\PyTorch\\checkpoints\\FunieGAN\\%s\\generator_%d.pth" % (dataset_name, args.epoch)))
    discriminator.load_state_dict(torch.load("E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\PyTorch\\checkpoints\\FunieGAN/%s\\discriminator_%d.pth" % (dataset_name, epoch)))
...
for epoch in range(epoch, num_epochs):
    ...
    if (epoch % ckpt_interval == 0):
        torch.save(generator.state_dict(), "E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\PyTorch\\checkpoints\\FunieGAN\\%s\\generator_%d.pth" % (dataset_name, epoch))
        torch.save(discriminator.state_dict(), "E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\PyTorch\\checkpoints\\FunieGAN/%s\\discriminator_%d.pth" % (dataset_name, epoch))

torch.save(generator.state_dict(), "E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\PyTorch\\b_models\\FunieGAN\\B_generator.pth" )
torch.save(discriminator.state_dict(), "E:\\Project_MLDL_IPCV\\UW IE and Super Resolution\\Implementation\\FUnIEGAN\\FUnIE-GAN-master\\FUnIE-GAN-master\\PyTorch\\b_models\\FunieGAN\\B_discriminator.pth" )
