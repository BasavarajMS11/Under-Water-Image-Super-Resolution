...
class GeneratorFunieGAN(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=3):
        ...
        # encoding layers
        self.down1 = UNetDown(in_channels, 30, bn=False)
        self.down2 = UNetDown(40, 120)
        self.down3 = UNetDown(160, 240)
        self.down4 = UNetDown(320, 240)
        self.down5 = UNetDown(320, 240, bn=False)
        # decoding layers
        self.up1 = UNetUp(320, 240)
        self.up2 = UNetUp(640, 240)
        self.up3 = UNetUp(640, 120)
        self.up4 = UNetUp(320, 30)
        self.final = nn.Sequential(
            nn.Upsample(scale_factor=2),
            nn.ZeroPad2d((1, 0, 1, 0)),
            nn.Conv2d(80, out_channels, 4, padding=1),
            nn.Tanh(),
        )
...
class DiscriminatorFunieGAN(nn.Module):
    ...
    def __init__(self, in_channels=3):
        ...
        self.model = nn.Sequential(
            *discriminator_block(in_channels*2, 30, bn=False),
            *discriminator_block(40, 60),
            *discriminator_block(80, 120),
            *discriminator_block(160, 240),
            nn.ZeroPad2d((1, 0, 1, 0)),
            nn.Conv2d(320, 1, 4, padding=1, bias=False)
        )
