...
from tensorflow.keras.layers import Add, Input, BatchNormalization, Activation, LeakyReLU
from tensorflow.keras.layers import Conv2D, Convolution2D, MaxPooling2D, UpSampling2D
